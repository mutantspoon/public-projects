...
├── AGENTS.md            # This file (directory overview)
...
- **Working on SpacePlanner?** See `SpacePlanner/AGENTS.md` for the build hook, selection architecture, and the .layout format tools
- **Working on WFI?** See `WFI/AGENTS.md` for scraper workflow, data refresh, and site structure
- **Working on Quill?** See `Quill/AGENTS.md` for build/run, AI comment system, and test harnesses
- **Working on FOT?** See `FOT/AGENTS.md` — static card site built with my son
